...
#Pmod for SPI to Pi
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets spi_sck_IBUF] #Poor placement of routhing between an IO pin and BUFG Because this is not a clk capable pin...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets spi_sck_IBUF]
set_property -dict {PACKAGE_PIN AB22 IOSTANDARD LVCMOS33} [get_ports spi_cs0]
set_property -dict {PACKAGE_PIN AB21 IOSTANDARD LVCMOS33} [get_ports spi_mosi]
set_property -dict {PACKAGE_PIN AB20 IOSTANDARD LVCMOS33} [get_ports spi_miso]
set_property -dict {PACKAGE_PIN AB18 IOSTANDARD LVCMOS33} [get_ports spi_sck]
set_property -dict {PACKAGE_PIN Y21 IOSTANDARD LVCMOS33} [get_ports spi_cs1]
#create_clock -period 160.000 -name spi_sck -waveform {0.000 80.000} [get_ports spi_sck]
...
#SPI
set_property -dict {PACKAGE_PIN T19 IOSTANDARD LVCMOS33} [get_ports FCS_B]
set_property -dict {PACKAGE_PIN P22 IOSTANDARD LVCMOS33} [get_ports DQ0]
set_property -dict {PACKAGE_PIN R22 IOSTANDARD LVCMOS33} [get_ports DQ1]
...
# Si5344
set_property -dict {PACKAGE_PIN M21 IOSTANDARD LVCMOS25} [get_ports PLL_MOSI]
set_property -dict {PACKAGE_PIN L21 IOSTANDARD LVCMOS25} [get_ports PLL_MISO]
set_property -dict {PACKAGE_PIN N18 IOSTANDARD LVCMOS25} [get_ports PLL_SS]
set_property -dict {PACKAGE_PIN J20 IOSTANDARD LVCMOS25} [get_ports PLL_SCK]

set_property -dict {PACKAGE_PIN B20 IOSTANDARD LVCMOS25} [get_ports PLL_EQ_OK]
set_property -dict {PACKAGE_PIN A20 IOSTANDARD LVCMOS25} [get_ports PLL_RESET_B]
set_property -dict {PACKAGE_PIN C14 IOSTANDARD LVCMOS25} [get_ports PLL_SEL0]
set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVCMOS25} [get_ports PLL_SEL1]



#FMC LEDs Test
set_property -dict {PACKAGE_PIN A13 IOSTANDARD LVCMOS25} [get_ports {led_fmc[0]}]
set_property -dict {PACKAGE_PIN A14 IOSTANDARD LVCMOS25} [get_ports {led_fmc[1]}]
set_property -dict {PACKAGE_PIN A15 IOSTANDARD LVCMOS25} [get_ports {led_fmc[2]}]
set_property -dict {PACKAGE_PIN A16 IOSTANDARD LVCMOS25} [get_ports {led_fmc[3]}]
...
#DDMTD CLKS....
#CLK A
set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVDS_25 DIFF_TERM 0} [get_ports CLK_A_P]
set_property -dict {PACKAGE_PIN L18 IOSTANDARD LVDS_25 DIFF_TERM 0} [get_ports CLK_A_N]
#CLK B
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVDS_25 DIFF_TERM 0} [get_ports CLK_B_P]
set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVDS_25 DIFF_TERM 0} [get_ports CLK_B_N]


#ONBOARD 200CLK
set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVDS_25 DIFF_TERM 0} [get_ports CLK_200_P]
set_property -dict {PACKAGE_PIN K19 IOSTANDARD LVDS_25 DIFF_TERM 0} [get_ports CLK_200_N]



# Clock from the PLL to sample from...
set_property -dict {PACKAGE_PIN B17 IOSTANDARD LVDS_25 DIFF_TERM 0} [get_ports CLK_P]
set_property -dict {PACKAGE_PIN B18 IOSTANDARD LVDS_25 DIFF_TERM 0} [get_ports CLK_N]
#create_clock -period 1.5 -name CLK_P -waveform {0.000 0.75}  [get_ports CLK_P]
#create_clock -period 6.250 -name CLK_N -waveform {0.000 3.125} [get_ports CLK_P]



##First Clock input FF (there are two FFs 1,2)
set_property -dict {PACKAGE_PIN N20 IOSTANDARD LVDS_25} [get_ports Q1A_P]
set_property -dict {PACKAGE_PIN M20 IOSTANDARD LVDS_25} [get_ports Q1A_N]
set_property -dict {PACKAGE_PIN M13 IOSTANDARD LVDS_25} [get_ports Q2A_P]
set_property -dict {PACKAGE_PIN L13 IOSTANDARD LVDS_25} [get_ports Q2A_N]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets Q1A]


#Second Clock input FF (there are two FFs 1,2)
set_property -dict {PACKAGE_PIN A18 IOSTANDARD LVDS_25} [get_ports Q1B_P]
set_property -dict {PACKAGE_PIN A19 IOSTANDARD LVDS_25} [get_ports Q1B_N]
set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVDS_25} [get_ports Q2B_P]
set_property -dict {PACKAGE_PIN D19 IOSTANDARD LVDS_25} [get_ports Q2B_N]
...
#set_false_path -from [get_clocks CLK_N] -to [get_clocks spi_sck]

#set_false_path -from [get_clocks spi_sck] -to [get_clocks CLK_N]

#create_clock -period 6.250 -name Q1A_P -waveform {0.000 3.125} -add [get_ports Q1A_P]
#create_clock -period 6.250 -name Q1B_P -waveform {0.000 3.125} -add [get_ports Q1B_P]
#create_generated_clock -name nclk_pll_by2 -source [get_pins nclk_pll_by2_reg/C] -divide_by 2 [get_pins nclk_pll_by2_reg/Q]
